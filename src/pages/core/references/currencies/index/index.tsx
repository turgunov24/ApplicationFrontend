...
export default function Page() {
  ...
  const [idForDeleteUser, setIdForDeleteUser] = useState<ICurrency['id'] | null>(null);
      ...
      columnHelper.accessor('id', {
        ...
        cell: (info) => (
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <RenderElementByPermission permissions={[referencesCurrenciesPermissions.update]}>
              <Tooltip title="Quick edit" placement="top" arrow>
                <IconButton
                  color="info"
                  onClick={() => {
                    setQueryStates({ currencyId: info.getValue(), formOpen: true });
                  }}
                >
            ...
            <RenderElementByPermission permissions={[referencesCurrenciesPermissions.delete]}>
  ...
  const { mutate: deleteUser } = useMutation({
    mutationKey: [REFERENCES_CURRENCIES_BASE_QUERY_KEY, 'delete'],
    mutationFn: async (id: ICurrency['id']) => {
      try {
        const response = await referencesCurrenciesService.form.delete(id);
        return response;
      } catch (error: unknown) {
        console.log('error', error);
        return false;
    ...
    <>
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          action={
            <RenderElementByPermission permissions={[referencesCurrenciesPermissions.create]}>
              <Button
                variant="contained"
