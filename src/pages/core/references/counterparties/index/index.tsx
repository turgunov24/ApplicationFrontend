...
export default function Page() {
  ...
  const [idForDeleteUser, setIdForDeleteUser] = useState<ICounterparty['id'] | null>(null);
      ...
      columnHelper.accessor('id', {
        ...
        cell: (info) => (
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <RenderElementByPermission permissions={[referencesCounterpartiesPermissions.update]}>
            ...
            <RenderElementByPermission permissions={[referencesCounterpartiesPermissions.delete]}>
  ...
  const { mutate: deleteUser } = useMutation({
    mutationKey: [REFERENCES_COUNTERPARTIES_BASE_QUERY_KEY, 'delete'],
    mutationFn: async (id: ICounterparty['id']) => {
      try {
        const response = await referencesCounterpartiesService.form.delete(id);
        return response;
      } catch (error: unknown) {
        console.log('error', error);
        return false;
    ...
    <>
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          action={
            <RenderElementByPermission permissions={[referencesCounterpartiesPermissions.create]}>
              <Button
                variant="contained"
