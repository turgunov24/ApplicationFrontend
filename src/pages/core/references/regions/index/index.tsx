      ...
      columnHelper.accessor('id', {
        ...
        cell: (info) => (
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <RenderElementByPermission permissions={[referencesRegionsPermissions.update]}>
            ...
            <RenderElementByPermission permissions={[referencesRegionsPermissions.delete]}>
    ...
    <>
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          action={
            <RenderElementByPermission permissions={[referencesRegionsPermissions.create]}>
              <Button
                variant="contained"
