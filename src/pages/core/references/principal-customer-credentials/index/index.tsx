...
export default function Page() {
  ...
  const [idForDeleteUser, setIdForDeleteUser] = useState<ICredential['id'] | null>(null);
      ...
      columnHelper.accessor('id', {
        ...
        cell: (info) => (
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <RenderElementByPermission permissions={[referencesPrincipalCustomerCredentialsPermissions.update]}>
              <Tooltip title="Quick edit" placement="top" arrow>
                <IconButton
                  color="info"
                  onClick={() => {
                    setQueryStates({ credentialId: info.getValue(), formOpen: true });
                  }}
                >
            ...
            <RenderElementByPermission permissions={[referencesPrincipalCustomerCredentialsPermissions.delete]}>
  ...
  const { mutate: deleteUser } = useMutation({
    mutationKey: [REFERENCES_PRINCIPAL_CUSTOMER_CREDENTIALS_BASE_QUERY_KEY, 'delete'],
    mutationFn: async (id: ICredential['id']) => {
      try {
        const response = await referencesPrincipalCustomerCredentialsService.form.delete(id);
        return response;
      } catch (error: unknown) {
        console.log('error', error);
        return false;
    ...
    <>
      ...
      <DashboardContent>
        <CustomBreadcrumbs
          ...
          action={
            <RenderElementByPermission permissions={[referencesPrincipalCustomerCredentialsPermissions.create]}>
              <Button
                variant="contained"
